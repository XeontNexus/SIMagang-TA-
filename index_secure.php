...
// Protect admin routes from direct access
if(strpos($_SERVER['REQUEST_URI'], '/admin') !== false) {
    header('HTTP/1.0 403 Forbidden');
    echo '<h1>Access Denied</h1>';
    echo '<p>Direct access to admin routes is not allowed.</p>';
    exit;
}
...
<body>
    <div class="login-container">
        <div class="login-header">
            <h3><i class="fas fa-briefcase me-2"></i><?= APP_NAME ?></h3>
        ...
        <div class="login-body">
            ...
            <div class="security-notice">
                ...
                <strong>Keamanan:</strong> Gunakan kredensial yang diberikan oleh administrator.
            </div>

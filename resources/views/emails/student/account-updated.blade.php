...
<head>
    ...
    <title>Akun PKL SIMagang Diperbarui</title>
</head>
        ...
        <tr>
            <td align="center">
                <table role="presentation" width="600" cellspacing="0" cellpadding="0" style="background-color: #ffffff; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 20px rgba(0,0,0,0.08);">
                    {{-- Header --}}
                    <tr>
                        <td style="background: linear-gradient(135deg, #f6c23e 0%, #dda20a 100%); padding: 32px 40px; text-align: center;">
                    ...
                    <tr>
                        <td style="padding: 40px;">
                            ...
                            <p style="margin: 0 0 24px; color: #718096; font-size: 15px; line-height: 1.6;">
                                Admin SIMagang menginformasikan bahwa <strong style="color: #2d3748;">akun PKL Anda telah diperbarui</strong>.
                                ...
                                <tr>
                                    <td style="padding: 20px 24px;">
                                        <table role="presentation" width="100%" cellspacing="0" cellpadding="0">
                                            <tr>
                                                <td style="padding: 6px 0; color: #718096; font-size: 14px; width: 140px;">Username</td>
                                                <td style="padding: 6px 0; color: #2d3748; font-size: 14px; font-weight: 600;">{{ $student->username }}</td>
                                            </tr>
                                            <tr>
                                                <td style="padding: 6px 0; color: #718096; font-size: 14px;">Password Baru</td>
                                                <td style="padding: 6px 0;">
                                                    <code style="background-color: #edf2f7; padding: 3px 10px; border-radius: 4px; color: #e53e3e; font-size: 14px; font-weight: 600;">{{ $newPassword }}</code>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                            ...
                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="margin-bottom: 24px;">
                                <tr>
                                    <td align="center">
                                        <a href="{{ $loginUrl }}" target="_blank" style="display: inline-block; background: linear-gradient(135deg, #f6c23e 0%, #dda20a 100%); color: #ffffff; text-decoration: none; padding: 14px 36px; border-radius: 8px; font-size: 15px; font-weight: 600; letter-spacing: 0.3px;">
                                ...
                                <tr>
                                    <td style="padding: 14px 20px;">
                                        <p style="margin: 0; color: #2b6cb0; font-size: 13px; line-height: 1.5;">
                                            ℹ️ Perubahan ini <strong>tidak menghapus</strong> data kemajuan (progress) akun Anda. Silakan login menggunakan kredensial baru.
                                        </p>
                                    </td>
                                </tr>
                            </table>

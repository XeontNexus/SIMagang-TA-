        ...
        <div class="content-wrapper">
            ...
            <nav class="sidebar" id="sidebar">
                ...
                <div class="user-profile">
                    ...
                    <div class="user-name">{{ $user->name ?? 'Guru' }}</div>
            ...
            <div class="main-content">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <div>
                        <h1 class="h3 mb-0">Dashboard Guru</h1>
                        <p class="text-muted mb-0">Selamat datang di SIMagang SMKN 1</p>
                    </div>
                    <div>
                        <span class="badge bg-success">{{ $user->role ?? 'guru' }}</span>
                    </div>
                </div>
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-lg-3 col-md-6 mb-4">
                        <div class="stat-card">
                            ...
                            <div class="stat-label">Penilaian Pending</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="list-group list-group-flush">
                            ...
                            <div class="list-group-item d-flex justify-content-between align-items-center">
                                <div>
                                    <h6 class="mb-1">Penilaian Selesai</h6>
                                    <p class="mb-1 text-muted">Test Siswa - Nilai: 85</p>
